...
public class E11_CajeroSC implements Runnable {
        ...
        E11_CajeroSC(E11_CuentaSC cuenta,double dinero) {
                this.dinero=dinero;
                this.cuenta=cuenta;
        }
        ...
        public static void main(String args []) {
                ...
                c= new E11_CuentaSC("a12315456456df4adf54",saldoInicial);
                ...
                {
                        ti[i]=new Thread(new E11_CajeroSC(c,1.));        //cada E11_CajeroSC de éstos mete 1 euro
                        tr[i]=new Thread(new E11_CajeroSC(c,-1.));        //cada E11_CajeroSC de éstos saca 1 euro
